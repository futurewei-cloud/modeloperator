...
import (
	...
	aiv1alpha1 "modeloperator/api/v1alpha1"
)
...
// +kubebuilder:rbac:groups=ai.kubeedge.io,resources=inferencemodels,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ai.kubeedge.io,resources=inferencemodels/status,verbs=get;update;patch
...
func (r *InferenceModelReconciler) desiredPod1(model aiv1alpha1.InferenceModel) (corev1.Pod, error) {
	pod := corev1.Pod{
			...
			Volumes: []corev1.Volume{
				{
					...
					VolumeSource: corev1.VolumeSource{
						HostPath: &corev1.HostPathVolumeSource{
							Path: "/var/lib/kubeedge/ai/models/" + model.Name,
						},
					},
				},
			},
